...
[Скачать v0.3.0](https://github.com/AT-Vadim/kapps-odometer/releases/download/v0.3.0/Odometer-Kapps-v0.3.0.zip) · [English documentation](README.md)

## Установка

1. Скачайте **Odometer-Kapps-v0.3.0.zip** в разделе **Releases** этого репозитория.
...
1. Временно замените URL Custom Overlay **внутри Kapps** на
   `http://127.0.0.1:8182/Odometer/?manage=1`.
2. Увеличьте окно и включите взаимодействие с ним. В блоке **Оформление одометра**
...
тёмный цвет и 70%, сохраняя выбранный стиль. Меняется только фон панели;
...
Увеличьте окно и включите взаимодействие с ним. **Скачать копию (Download backup)** скачивает
...
**v0.3.0.** Протокол сверён с Kapps **1.24.38**, подключение к серверу проверено.
...
и масштабирование всех трёх стилей. Полная проверка во время
