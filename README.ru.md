...
[Скачать v0.2.1](https://github.com/AT-Vadim/kapps-odometer/releases/download/v0.2.1/Odometer-Kapps-v0.2.1.zip) · [English documentation](README.md)

## Установка

1. Скачайте **Odometer-Kapps-v0.2.1.zip** в разделе **Releases** этого репозитория.
...
**v0.2.1.** Протокол сверён с Kapps **1.24.38**, подключение к серверу проверено.
