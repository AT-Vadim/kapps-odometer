...
[Скачать v0.1.0](https://github.com/AT-Vadim/kapps-odometer/releases/download/v0.1.0/Odometer-Kapps-v0.1.0.zip) · [English documentation](README.md)

## Установка

1. Скачайте **Odometer-Kapps-v0.1.0.zip** в разделе **Releases** этого репозитория.
...
5. Выделите виджету примерно **370 × 95 px** и разместите его на экране.
...
**v0.1.0.** Протокол сверён с Kapps **1.24.38**, подключение к серверу проверено.
