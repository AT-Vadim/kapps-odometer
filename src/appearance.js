...
(function(root){
 ...
 function mount(db,panel){
   ...
   select.onchange=function(){update({style:select.value});};
   ...
   reset.onclick=function(){hex.setCustomValidity('');update({backgroundColor:defaults.backgroundColor,backgroundOpacity:defaults.backgroundOpacity});};
